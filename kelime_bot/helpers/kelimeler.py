...
kelimeler = ["gözəl ","məlumat ","sual","sağlam ","buraxmaq","yaraşıqlı","su","etmək","işlədmək","deyil","görmək",
             ...
             'mükafatlandırmaq', 'nanə', 'basmaq', 'kenar', 'kontrol', 'çevirmek', 'din', 'güçlü', 'tor', 'plan', 'beyin',
             'elektrik', 'cahil', 'deşmək', 'ət', 'lampa', 'söyləmək', 'çizgi', 'möhtəşəm', 'alim', 'cild', 'ruh',
             'sevilmək', 'şəlalə', 'nazirlik', 'baxışmaq', 'sahiblənmək', 'ileri', 'ifade', 'beden', 'xatırlamaq', 'qüsurlu',
             ...
             'seyretmek', 'birden', 'içermek', 'sayılmak', 'toplamak', 'aşmak', 'bağırmak', 'məsuliyət', 'davranmaq',
             'məktub', 'soymaq', 'canlı', 'iddia', 'makine', 'yararlanmak', 'yaşlı', 'boş', 'ayaqqabı', 'futbol', 'adminstrator',
             'oğurlamaq', 'müqavilə', 'tutulmaq', 'baxımlı', 'bitki', 'görkəmli', 'dərman', 'borclu', 'yastıq', 'keçərli',
             'mühavizə', 'imkan', 'ceza', 'haqsızlıq', 'dincələmək', 'top', 'psixoloq', 'doldurmaq', 'kanal', 'məkan', 'arı',
